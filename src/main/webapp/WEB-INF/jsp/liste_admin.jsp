        ...
        <div class="fullwidth-block">
            <div class="container">
                <div class="filterable-items">
                    ...
                    <div class="filterable-item south-america">
                        <article class="offer-item">
                            ...
                            <h2 class="entry-title"><a href="#"><%= commune.getTitre() %></a></h2>
                            <p><%= commune.getAbout() %></p>
                            <strong><%= commune.getDate1() %></strong>
                            <small><%= commune.getDate2() %></small>
                        </article>
                        <% if(commune.getEtat()==1) {%>
                        <a href="/spring/update?re=<%= commune.getId() %>"><button>valider</button></a>
                        <%}%>
                    </div>
                    <%  } %>
                </div>
                ...
                <div class="pagination wow fadeInUp">
                    ...
                    <span class="page-numbers current"> <a href="/spring/get_all_for_admin?limite=<%=i%>"><%=i+1%></a></span>
                    <%}%>
                </div>
